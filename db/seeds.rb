...
Product.create(primary_code: '01', description: 'Configuración de servidor HP', company: 1)
Product.create(primary_code: '02', description: 'Hosting standard por 1 año', company: 1)
Product.create(primary_code: '03', description: 'Servicio por implementación de correos', company: 1)
Product.create(primary_code: '04', description: 'Soporte informatico mensual', company: 1)
Product.create(primary_code: '05', description: 'Arreglos de impresoras', company: 1)
Product.create(primary_code: '06', description: 'Desarrollo de aplicación móvil ', company: 1)
