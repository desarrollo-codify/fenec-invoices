...
RSpec.describe Api::V1::CyclesController, type: :routing do
  describe 'routing' do
    it 'routes to #index' do
      expect(get: '/api/v1/companies/1/cycles').to route_to('api/v1/cycles#index', company_id: '1')
    end
    ...
    it 'routes to #create' do
      expect(post: '/api/v1/companies/1/cycles').to route_to('api/v1/cycles#create', company_id: '1')
    end
