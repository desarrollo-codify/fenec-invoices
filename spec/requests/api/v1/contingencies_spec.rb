...
RSpec.describe 'Api::V1::Contingencies', type: :request do
  ...
  describe 'GET /show' do
    ...
    it 'renders a successful response' do
      get api_v1_contingency_url(contingency), as: :json
  ...
  describe 'PUT /update' do
    ...
    context 'with invalid parameters' do
      ...
      it 'renders a JSON response with errors for the contingency' do
        put api_v1_contingency_url(contingency),
            params: { contingency: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested contingency' do
      ...
      expect do
        delete api_v1_contingency_url(contingency), headers: valid_headers, as: :json
