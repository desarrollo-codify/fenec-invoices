...
RSpec.describe '/api/v1/exchange_rates', type: :request do
  ...
  describe 'GET /index' do
    ...
    it 'renders a successful response' do
      ...
      get api_v1_company_exchange_rates_url(company_id: company.id), headers: valid_headers, as: :json
  ...
  describe 'GET /show' do
    ...
    it 'renders a successful response' do
      get api_v1_exchange_rate_url(exchange_rate), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe 'POST /create' do
      ...
      it 'creates a new ExchangeRate' do
        expect do
          post api_v1_company_exchange_rates_url(company_id: @company.id),
               params: { exchange_rate: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      ...
      it 'renders a JSON response with errors for the new api_v1_company_exchange_rate' do
        post api_v1_company_exchange_rates_url(company_id: @company.id),
             params: { exchange_rate: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with valid parameters' do
      ...
      it 'updates the requested api_v1_exchange_rate' do
        patch api_v1_exchange_rate_url(exchange_rate),
              params: { exchange_rate: new_attributes }, headers: valid_headers, as: :json
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested api_v1_exchange_rate' do
      exchange_rate = create(:exchange_rate)
      expect do
        delete api_v1_exchange_rate_url(exchange_rate), headers: valid_headers, as: :json
      end.to change(ExchangeRate, :count).by(-1)
    end
  end
end
