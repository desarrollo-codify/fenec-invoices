...
RSpec.describe '/api/v1/contingency_codes', type: :request do
  ...
  describe 'GET /show' do
    ...
    it 'renders a successful response' do
      get api_v1_contingency_code_url(contingency_code), as: :json
    ...
    context 'with valid parameters' do
      ...
      it 'updates the requested contingency_code' do
        put api_v1_contingency_code_url(contingency_code),
            params: { contingency_code: new_attributes }, headers: valid_headers, as: :json
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested contingency_code' do
      ...
      expect do
        delete api_v1_contingency_code_url(contingency_code), headers: valid_headers, as: :json
