...
RSpec.describe "/api/v1/brands", type: :request do
  ...
  # Api::V1::Brand. As you add validations to Api::V1::Brand, be sure to
  ...
  # Api::V1::BrandsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get api_v1_brands_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get api_v1_brand_url(brand), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "POST /create" do
      ...
      it "creates a new Brand" do
        expect {
          post api_v1_brands_url,
               params: { api_v1_brand: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Brand" do
        expect {
          post api_v1_brands_url,
               params: { api_v1_brand: invalid_attributes }, as: :json
        }.to change(Brand, :count).by(0)
      end

      it "renders a JSON response with errors for the new api_v1_brand" do
        post api_v1_brands_url,
             params: { api_v1_brand: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested api_v1_brand" do
        ...
        patch api_v1_brand_url(brand),
              params: { api_v1_brand: new_attributes }, headers: valid_headers, as: :json
        brand.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested api_v1_brand" do
      brand = Brand.create! valid_attributes
      expect {
        delete api_v1_brand_url(brand), headers: valid_headers, as: :json
      }.to change(Brand, :count).by(-1)
    end
  end
end
