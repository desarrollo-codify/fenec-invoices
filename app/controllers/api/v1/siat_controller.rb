  ...
  module V1
    class SiatController < ApplicationController
      ...
      def generate_cufd
        ...
        return render json: { message: "La solicitud a SIAT obtuvo el siguiente error: #{data[:mensajes_list][:descripcion]}" }, status: :unprocessable_entity unless data[:transaccion]
