...
module Api
  module V1
    class CompaniesController < ApplicationController
      ...
      # GET /companies/1
      def show
        @company = Company.includes(:economic_activities, :company_setting, :page_size, :invoice_types, :measurements, :modality, :environment_type, :document_sector_types, branch_offices: :point_of_sales)
                          .find(params[:id])
