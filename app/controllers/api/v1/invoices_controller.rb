  ...
  private
    ...
    def invoice_params
      ...
      params.require(:invoice).permit(:number, :date, :company_name, :company_nit, :business_name, :business_nit,
        :authorization, :key, :end_date, :activity_type, :control_code, :qr_content, :subtotal, :discount, :total,
        :paid, :change, :cancellation_date, :exchange_rate, :cuis_code, :cufd_code)
    end
end
